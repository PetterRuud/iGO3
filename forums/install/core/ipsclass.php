	...
	*/
	function initiate_ipsclass()
	{
		...
		if ( $this->vars['xforward_matching'] )
		{
			...
			$addrs[] = "127.0.0.1";//$this->my_getenv('HTTP_CLIENT_IP');
			$addrs[] = "127.0.0.1";//$this->my_getenv('HTTP_PROXY_USER');
		}
		
		$addrs[] = "127.0.0.1";//$this->my_getenv('REMOTE_ADDR');
		...
		{
			print "ipsclass Could not determine your IP address";
			exit();
		}
