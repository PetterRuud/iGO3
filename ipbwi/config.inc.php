<?php
	...
	if(!defined('ipbwi_ROOT_PATH')){
		define('ipbwi_ROOT_PATH','/Users/Petter/Dropbox/Web/Webapplikasjoner/iGO3/ipbwi/');
	}
	...
	if(!defined('ipbwi_UPLOAD_PATH')){
		define('ipbwi_UPLOAD_PATH','/Users/Petter/Dropbox/Web/Webapplikasjoner/iGO3/ipbwi/uploads/');
	}
	...
	if(!defined('ipbwi_WEB_URL')){
		define('ipbwi_WEB_URL','http://localhost/Webapplikasjoner/iGO3/');
	}
